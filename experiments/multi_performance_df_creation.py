...
def get_cp(pitch, prom=70):
    peaks = find_peaks(pitch, prominence=prom)
    troughs = find_peaks(-pitch, prominence=prom)
    return len(peaks[0])+len(troughs[0])
